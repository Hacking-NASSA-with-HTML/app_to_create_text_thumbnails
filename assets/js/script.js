        ...
        `<main id="main">
            ...
            <div class="wrapper">
                <div class="canvas_1200_630">
                    ...
                    <p class="thumb-text_1200_630">Customize your text in JavaScript file, outline color in CSS file.</p>
                ...
                <div class="canvas_400_400">
                    ...
                    <p class="thumb-text_400_400">Customize your text in JavaScript file, outline color in CSS file.</p>
